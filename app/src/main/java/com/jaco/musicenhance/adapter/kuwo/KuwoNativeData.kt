...
internal object KuwoNativeData {
    ...
    fun install(loader: ClassLoader) = safeHook("Kuwo lyrics association") {
        ...
        module.installHook(method, "musicenhance.kuwo.lyrics", Hooker { chain ->
    ...
    class Reader(loader: ClassLoader) {
        ...
        fun lyrics(player: PlayerSnapshot): LyricsSnapshot? {
        ...
        fun artwork(root: ViewGroup): Bitmap? = runCatching {
