...
internal object KugouLiteLyrics {
    private val sources = KugouLiteLyricStore()
    ...
    fun install(loader: ClassLoader) {
        safeHook("Kugou Lite lyric download identity") {
            ...
            module.installHook(type.getMethod("v"), "musicenhance.kugoulite.lyric.download", Hooker { chain ->
        ...
        safeHook("Kugou Lite lyric source") {
            ...
            module.installHook(load, "musicenhance.kugoulite.lyric.path", Hooker { chain ->
                val result = chain.proceed()
    ...
    class Reader(loader: ClassLoader) {
        private val api = KugouLiteLyricApi(loader)
        ...
        fun read(player: PlayerSnapshot): LyricsSnapshot? {
