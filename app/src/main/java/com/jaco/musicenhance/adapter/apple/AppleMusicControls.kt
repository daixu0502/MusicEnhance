...
internal class AppleMusicControls(private val resources: Resources) : MediaSessionControlReader {
    ...
    private fun icon(name: String): Int = resources.getIdentifier(name, "drawable", AppleMusicProfile.packageName)
