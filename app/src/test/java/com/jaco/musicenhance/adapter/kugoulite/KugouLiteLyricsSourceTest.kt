...
class KugouLiteLyricsSourceTest {
    ...
    @Test fun nativeWordArraysProduceSortedTimedLinesWithMissingRowsIgnored() {
        val lines = KugouLiteLyricsApi.decodeLines(
        ...
        assertTrue(KugouLiteLyricsApi.decodeLines(null, emptyArray<Any>()).isEmpty())
    }
}
