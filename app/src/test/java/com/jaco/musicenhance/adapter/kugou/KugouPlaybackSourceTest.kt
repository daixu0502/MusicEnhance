...
class KugouPlaybackSourceTest {
    ...
    object Utility {
        ...
        @JvmStatic fun E2() = service
        @JvmStatic fun Q1() = current
    }
    ...
    class Service {
        ...
        fun J(source: Int) { assertEquals(2, source); playing = true; playCalls++ }
